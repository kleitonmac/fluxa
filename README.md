<p align="center">
  ...
  <img src="docs/screenshots/login.png" alt="Fluxa — Landing Page" width="100%" />
  <br />
  <em>Tela de login com autenticação por email/senha, Google e Microsoft</em>
  <img src="docs/screenshots/visaoDesktop.png" alt="Fluxa — Landing Page" width="100%" />
  <br />
  <em>Dashboard principal com KPIs, gráficos de tendência mensal/anual, distribuição por categoria e insights</em>
</p>

<h1 align="center">Fluxa Financeiro</h1>

<p align="center">
  <strong>Plataforma SaaS de gestão financeira completa — controle de despesas, vendas, carteira internacional, relatórios inteligentes e billing integrado com Stripe.</strong>
</p>
